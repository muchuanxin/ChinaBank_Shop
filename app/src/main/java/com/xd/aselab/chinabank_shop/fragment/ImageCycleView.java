...
public class ImageCycleView extends LinearLayout {
    ...
    public void setImageResources(ArrayList<String> urlList, ImageCycleViewListener imageCycleViewListener) {
        ...
        imageCycleAdapter = new ImageCycleAdapter(mContext, urlList, imageCycleViewListener);
        cycleViewPager.setAdapter(imageCycleAdapter);
        startImageTimerTask();
    }
    ...
    private class ImageCycleAdapter extends PagerAdapter {
        ...
        public ImageCycleAdapter(Context context, ArrayList<String> imageUrls, ImageCycleViewListener imageCycleViewListener) {
            mContext = context;
