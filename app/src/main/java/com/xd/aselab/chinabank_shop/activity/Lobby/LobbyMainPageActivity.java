...
import com.xd.aselab.chinabank_shop.activity.Lobby.fragment.LobbyMainFragment;
import com.xd.aselab.chinabank_shop.activity.Lobby.fragment.LobbyMeBasicFragment;
...
public class LobbyMainPageActivity extends AppCompatActivity {

    private LobbyMainFragment fra_main;
    private ChatFragment fra_chat;
    private RecommendFragment fra_recommend;
    private LobbyMeBasicFragment fra_me_basic;
//    private MeManagerFragment fra_me_manager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spu = new SharePreferenceUtil(LobbyMainPageActivity.this, "user");
        initViews();
    ...
    private void setTabSelection(int index) {
        ...
        switch (index) {
            case 0:
                ...
                if (fra_main == null) {
                    fra_main = new LobbyMainFragment ();
...
//                    fra_chat = new ChatFragment();
            ...
            case 3:
                ...
                if (fra_me_basic == null) {
                    fra_me_basic = new LobbyMeBasicFragment();
...
/*        if (fra_me_manager != null){
    ...
    protected void onResume() {
        ...
        getMyCreateGroup();
        parseData();
        JPushInterface.setAlias(LobbyMainPageActivity.this, new Random().nextInt() ,spu.getAccount());
                ...
                switch (msg.what){
                        ...
                        try {
                            ...
                            if (reCode!=null){
                                ...
                                if ("false".equals(status)) {
                                    Toast.makeText(LobbyMainPageActivity.this, json.getString("message"), Toast.LENGTH_SHORT).show();
                    ...
                    case 1:
                        try {
                            ...
                            JPushInterface.setTags(LobbyMainPageActivity.this, new Random().nextInt() ,groupSet);
                        }catch (Exception e){
                            e.printStackTrace();
                        }
                        break;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if ((System.currentTimeMillis() - mExitTime) > 2000) {
                Toast.makeText(LobbyMainPageActivity.this, "再按一次退出程序", Toast.LENGTH_SHORT).show();
        ...
        public void onReceive(Context context, Intent intent) {
            try {
                if (MESSAGE_RECEIVED_ACTION.equals(intent.getAction())) {
                    ...
                    SharePreferenceUtil spu = new SharePreferenceUtil(LobbyMainPageActivity.this,"user");
