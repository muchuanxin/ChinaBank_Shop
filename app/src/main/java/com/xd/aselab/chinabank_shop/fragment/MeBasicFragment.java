...
public class MeBasicFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        unexchange_score=(TextView) root.findViewById(R.id.unexchange_score);
        user_name = (TextView) root.findViewById(R.id.user_name);
        exchange_score_line=(LinearLayout) root.findViewById(R.id.exchange_score_line);
        ...
        exchange_score_line.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(getActivity(), CardDivExchangeScoreActivity.class);
                startActivity(intent);
            }
        });
