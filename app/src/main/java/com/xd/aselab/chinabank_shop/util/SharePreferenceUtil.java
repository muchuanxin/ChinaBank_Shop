...
public class SharePreferenceUtil {
    ...
    public String getErji_Num() {
        return sp.getString("erji_num", "");
    }
    ...
    public String getSiji_Num() {
        return sp.getString("siji_num", "");
    }
