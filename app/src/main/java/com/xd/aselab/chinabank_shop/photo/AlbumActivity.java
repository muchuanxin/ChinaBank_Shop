...
import com.xd.aselab.chinabank_shop.photo.util.AlbumHelper;
import com.xd.aselab.chinabank_shop.photo.util.ImageBucket;
import com.xd.aselab.chinabank_shop.photo.util.PublicWay;
                    ...
                    public void onItemClick(final ToggleButton toggleButton,
                        ...
                        if (Bimp.tempSelectBitmap.size() >= PublicWay.num) {
                            ...
                            if (!removeOneData(dataList.get(position))) {
                                Toast.makeText(AlbumActivity.this, "超出可选图片范围",
